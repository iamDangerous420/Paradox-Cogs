...
class Antilink:
    """Blocks Discord invite links from users who don't have the permission 'Manage Messages, bot commander or moderators roles. '
    Or your personnally set server adminrole / modrole"""
